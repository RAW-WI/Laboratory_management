...
@WebServlet("/Up_class_show")
public class Up_class_show extends HttpServlet {
    public Up_class_show(){
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(labora_delete_in_val.equals("all")){
            try {
                resultArray = date_show.show_class_log();
...
//            // Send JSON response to the client
        ...
        }else if(labora_delete_in_val.equals("class")){
            try {
                resultArray = date_show.show_class_log_class(V_class);
                ObjectMapper objectMapper = new ObjectMapper();
                String jsonResult = objectMapper.writeValueAsString(resultArray);
//            Gson gson = new Gson();
//            String json = gson.toJson(resultArray);
...
//            // Send JSON response to the client
        ...
        }else if(labora_delete_in_val.equals("class_tt")){
            try {
                resultArray = date_show.show_class_log_class_tt(V_class);
                ObjectMapper objectMapper = new ObjectMapper();
                String jsonResult = objectMapper.writeValueAsString(resultArray);
//            Gson gson = new Gson();
//            String json = gson.toJson(resultArray);
...
//            // Send JSON response to the client
        ...
        }else if(labora_delete_in_val.equals("teacher")){
            try {
                resultArray = date_show.show_class_log_teacher(V_class);
                ObjectMapper objectMapper = new ObjectMapper();
                String jsonResult = objectMapper.writeValueAsString(resultArray);
//            Gson gson = new Gson();
//            String json = gson.toJson(resultArray);
