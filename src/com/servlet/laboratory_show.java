...
@WebServlet("/laboratory_show")
public class laboratory_show extends HttpServlet {
    public laboratory_show() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (labora_delete_in_val.equals("all")) {
            try {
                resultArray = date_show.show_laboratory_log();
...
//            // Send JSON response to the client
        ...
        } else if (labora_delete_in_val.equals("ID")) {
            try {
                resultArray = date_show.show_laboratory_log(V_class);
                ObjectMapper objectMapper = new ObjectMapper();
                String jsonResult = objectMapper.writeValueAsString(resultArray);
//            Gson gson = new Gson();
//            String json = gson.toJson(resultArray);
